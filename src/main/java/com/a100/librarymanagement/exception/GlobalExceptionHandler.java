...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FavoriteBookNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleFavoriteBookNotFound(FavoriteBookNotFoundException ex) {
        return ResponseEntity
